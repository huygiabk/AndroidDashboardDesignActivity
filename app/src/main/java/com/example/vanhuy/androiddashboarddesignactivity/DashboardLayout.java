...
public class DashboardLayout extends ViewGroup{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b){
        ...
        // Calculate what number of rows and columns will optimize for
        // even horizontal and vertical whitespace between items.
        // Start with a 1 x N grid, then try 2 x N, and so on.
        ...
        while (true) {
            ...
            if (spaceDifference < bestSpaceDifference) {
                ...
                // there’s only 1 row, this is the best we can do.
                if (rows == 1) {
                    break;
                }
            } else {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(left, top, (hSpace == 0 && col == cols - 1) ?
                    r : (left + width), (vSpace == 0 && row == rows - 1) ?
                    b : (top + height));
            ++visibleIndex;
        }
    }
